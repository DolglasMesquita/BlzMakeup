...
namespace BlzMakeup.Areas.Admin.Controllers
{
    ...
    public class AdminProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemThumbnailUrl,Destaque,Estoque,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemThumbnailUrl,Destaque,Estoque,CategoriaId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
